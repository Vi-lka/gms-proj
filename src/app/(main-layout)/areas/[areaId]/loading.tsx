...
export default function LoadingAreaDataPage() {
  return (
        ...
        <BreadcrumbList>
          ...
          <BreadcrumbItem>
            <BreadcrumbPage className='flex gap-0.5 items-center'>
              <Skeleton className='w-24 h-5 md:block hidden' />
              <Slash size={16} className='text-muted-foreground/50 -rotate-45 md:block hidden' />
              <Skeleton className='w-24 h-5' />
            </BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
