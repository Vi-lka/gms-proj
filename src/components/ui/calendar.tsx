...
function Calendar({
  ...
  const { onNextClick: onNxtClick, onPrevClick, startMonth, endMonth } = props
  ...
  return (
    <DayPicker
      ...
      components={{
        ...
        Nav: ({ nextMonth, previousMonth, onNextClick, onPreviousClick, className, children, ...props }) => {
